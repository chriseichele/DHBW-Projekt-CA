	...
	<?php
		...
		if($myrequest) {
    		...
    		if($csr['status'] == 'created') {
    			...
    			echo '<button onclick="return confirm(\'Sind Sie sicher, dass Sie den CSR unwiderruflich l&ouml;schen m&ouml;chten?\');" class="btn btn-danger btn-lg btn-block" role="button">Request unwiderruflich l&ouml;schen</button>';
    			echo '</form>';
    		}
    		echo '</div>';
		}
